...
def get_word_score(word, n):
    ...
    if (7*wordlen-3*(n-wordlen))<=1:
        ...
        return wordScore*(7*wordlen-3*(n-wordlen))
    ...
    while len(hand)!=0:
        ...
        # If the word is valid:
            ...
            if is_valid_word(guess,hand,word_list):
                ...
                print("Your score for this word is: ",get_word_score(guess,calculate_handlen(hand)))
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    while number_of_hands_left > 0:
        ...
        answer = input("Do you want to replay that hand (Yes/No)\n")
        if answer == "yes":
